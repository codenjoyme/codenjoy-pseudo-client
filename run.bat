...
:run
    ...
    call :eval_echo "%MVNW% clean compile exec:java -Dfile.encoding=UTF-8 -Dexec.mainClass=com.codenjoy.dojo.PseudoRunner -Dexec.args=`%GAME_TO_RUN% %SERVER_URL% %PSEUDO_RULES%`"
